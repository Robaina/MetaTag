...
required.add_argument('--data', dest='data', type=str, required=True,
                      help='path mardb assembly fasta file')
required.add_argument('--ids', dest='ids', type=str, required=True,
                      help='path to pickle with original query sequence ids')
optional.add_argument('--out', dest='outdir', type=str,
                      help='path to output directory')
optional.add_argument('--proc', dest='proc', type=int,
                      help='number of processes to use')                  

args = parser.parse_args()
if args.outdir is None:
    args.outdir = utils.setDefaultOutputPath(args.data, only_dirname=True)
