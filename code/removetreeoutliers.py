...
optional.add_argument('--ref_database', dest='infasta', type=str, default=None,
                      help=(
                          'path to reference database in fasta format, if provided, '
                          'a new fasta will be returned with outlier sequences removed'
                          )
                          )
optional.add_argument('--aln', dest='aln', type=str, default=None,
...
def readRefSequencesToRemove(treeshrink_deleted: str, except_prefix: str = None) -> list:
    """
